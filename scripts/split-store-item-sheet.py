"""Split the Raqeem 3x3 store-item sheet, then knock out studio white."""
...
SHEET = Path(r"C:\Users\vip\.cursor\projects\d-laragon\assets\raqeem-store-items-sheet.png")
TMP = Path(r"C:\Users\vip\.cursor\projects\d-laragon\assets\store-items-split")
OUT = ROOT / "public" / "images" / "store"
